#!/bin/bash
###############################################################################
# Generate Base Encoder Embeddings - 6way (GPU 0)
###############################################################################
...
echo "=================================="
echo "6WAY EMBEDDING GENERATION (GPU 1)"
echo "=================================="
...
for encoder_spec in "${ENCODERS[@]}"; do
    ...
    for layer in "${LAYERS[@]}"; do
        ...
        python generate_sroberta_npz_6way.py \
            --model_name "${model_name}" \
            --out_root "../data/embeddings/6way/${out_name}" \
            --layer "${layer}" \
