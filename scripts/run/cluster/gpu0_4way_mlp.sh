#!/bin/bash
###############################################################################
# GPU 0: 4way MLP (BERT + RoBERTa, n=10 seeds)
...
echo "==========================================="
echo "GPU 0: 4way MLP (BERT + RoBERTa, n=10)"
echo "==========================================="
...
mkdir -p "${SUMMARY_DIR}"
SUMMARY_FILE="${SUMMARY_DIR}/gpu0_4way_mlp.txt"
echo "GPU 0: 4way MLP (n=10)" > "${SUMMARY_FILE}"
