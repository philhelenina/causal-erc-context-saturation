#!/bin/bash
###############################################################################
# GPU 2: Sentence-RoBERTa-hier (baseline + concat)
...
echo "==========================================="
echo "GPU 2: Sentence-RoBERTa-hier"
echo "==========================================="
...
# Log file
LOG_FILE="${RESULTS_DIR}/gpu2_sentence_roberta.log"
mkdir -p "${RESULTS_DIR}"
echo "GPU 2: Sentence-RoBERTa-hier" > "${LOG_FILE}"
...
echo ""
echo "==========================================="
echo "✅ GPU 2 Complete (Sentence-RoBERTa)"
echo "==========================================="
